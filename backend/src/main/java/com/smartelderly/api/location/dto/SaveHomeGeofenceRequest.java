...
public class SaveHomeGeofenceRequest {
    ...
    public SaveHomeGeofenceRequest() {
    }

    public SaveHomeGeofenceRequest(String name, BigDecimal centerLatitude, BigDecimal centerLongitude,
