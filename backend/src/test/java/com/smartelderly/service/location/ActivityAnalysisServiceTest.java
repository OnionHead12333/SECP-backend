...
public class ActivityAnalysisServiceTest {
    ...
    public void setUp() {
        ...
        // Keep unit tests independent from wall-clock time. The service checks LocalTime.now().
        rule.setActiveStartTime(LocalTime.MIN);
        rule.setActiveEndTime(LocalTime.MAX);
    ...
    public void testRunAnalysisJob_MultipleEnabledRules() {
        ...
        rule2.setActiveStartTime(LocalTime.MIN);
        rule2.setActiveEndTime(LocalTime.MAX);
